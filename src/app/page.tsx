      ...
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
          <p className="text-sm font-semibold text-gray-700 cursor-pointer">
            Aresight is now public!
          </p>
        </div>
        <h1 className="max-w-5xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Dynamics of <span className="text-blue-600">annual reports</span><br/>
          from <span className="text-blue-600">year to year</span><br/>
          and <span className="text-blue-600">sector to sector</span>
        </h1>
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Aresight allows you to upload annual reports of your selected companies and start asking questions right away.
        </p>
